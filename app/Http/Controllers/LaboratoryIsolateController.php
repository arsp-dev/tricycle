...
class LaboratoryIsolateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('alert-success', 'Successfully updated laboratory isolate with accession :  <b>' . $isolate->patient_id . '</b> <br> Sentinel Site :  <b>' . $hospital->hospital_name . '</b>');
